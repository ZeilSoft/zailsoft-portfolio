const MainService = () => {
  return (
    <div className="text-white flex flex-col gap-4 justify-center items-center lg:flex-row lg:justify-evenly">
      <div className="flex flex-col gap-6">
        <h3 className="text-2xl font-semibold max-w-[580px] lg:text-[30px] leading-[35px] lg:leading-[51px]">
          <span className="text-[#374151]">Nos especializamos</span> en Fintech e integración de pagos con amplia
